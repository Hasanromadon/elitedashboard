...
function App() {
  return (
    <div className='flex'>
     <aside>
      <img className='mb-8' src='./icons/logo.png' alt=''/>
      <nav>
        ...
        <div className='link-group-title'>MARKETPLACE</div>
          <ul className='nav-link'>
            <li className='flex'>
              <a href='/' className='w-full'>
                <div className='link-container flex w-full text-purple-600'>
                  <svg className='icon-link' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
             <a href='/' className='w-full'>
             <div className='link-container flex w-full text-purple-600'>
                <svg className='icon-link' width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a href='/' className='w-full'>
              <div className='link-container flex w-full text-purple-600'>
                <svg className='icon-link' width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
